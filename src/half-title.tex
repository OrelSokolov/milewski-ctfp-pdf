...
% Disable page numbering for cover pages
\pagenumbering{gobble}

% Cover page with piggie
\thispagestyle{empty}
\begin{center}
...
\includegraphics[width=0.45\textwidth]{cover/piggie.png}\\[1.2cm]
...
% Enable page numbering after cover pages
